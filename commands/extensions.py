...
from peerless import Bot, developer_only
from peerless.interaction import BeforeInteraction, Defer
...
class Sync(commands.Cog):
    ...
    @app_commands.command(
        ...
        extras={'before': BeforeInteraction(
            defer=Defer(defer=True, ephemerally=True)
        )},
    )
    @app_commands.describe(command="the command to execute", globally="whether to globally sync or unsync the commands", guild_str="the guild to sync or unsync")
